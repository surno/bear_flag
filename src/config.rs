//! Configuration constants and types for flag generation

use crate::error::FlagError;
use crate::models::{DevicePreset, OutputFormat};
...
///
/// Specifies dimensions, output format, paw sizing, and rendering options
#[derive(Debug, Clone)]
