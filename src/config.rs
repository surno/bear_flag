//! Flag generation configuration primitives.
...
impl FlagConfig {
    ...
    pub fn validate(&self) -> Result<(), crate::error::FlagError> {
        ...
        if self.width > 10_000 || self.height > 10_000 {
            return Err(crate::error::FlagError::InvalidConfig(
...
mod tests {
    ...
    #[test]
    fn validate_rejects_excessive_dimensions() {
        let config = FlagConfig {
            width: 20_000,
            ..FlagConfig::default()
        };
    ...
    #[test]
    fn validate_rejects_invalid_paw_ratio() {
        let config = FlagConfig {
            paw_size_ratio: 1.5,
            ..FlagConfig::default()
        };
    ...
    #[test]
    fn from_preset_loads_dimensions() {
    ...
    #[test]
    fn output_format_mime_types_are_correct() {
    ...
    #[test]
    fn device_preset_display_names() {
