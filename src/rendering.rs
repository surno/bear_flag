//! Image rendering logic for flag generation
//!
//! Handles SVG rendering, stripe drawing, alpha compositing, and final image encoding

use crate::config::{FlagConfig, BEAR_PALETTE, BEAR_PAW_SVG, SMOOTH_WIDTH};
